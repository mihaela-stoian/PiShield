...
setup(
    ...
    description="A NeSy Framework for Learning with Requirements",  # Optional
    ...
    # above.
    author_email="mihaela.stoian@cs.ox.ac.uk",  # Optional
    ...
    install_requires=['numpy', 'torch', 'networkx'],  # Optional
